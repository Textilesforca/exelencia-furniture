      ...
      {items.length === 0 ? (
        ...
        <>
          <ul className="grid gap-4 mb-8">
            {items.map((item) => (
              <li key={item.id} className="flex flex-wrap items-center gap-4 bg-surface border border-line rounded-sm p-4">
                <img
                  src={item.imagen}
                  alt={item.nombre}
                  className="w-20 h-20 object-cover rounded-sm bg-surface2 shrink-0"
                />
                ...
                <div className="flex items-center gap-4 ml-auto">
                  ...
                  <p className="font-mono text-sm text-parchment w-20 text-right shrink-0">
